...
04302368 4E800020
```
> Using this code may cause the game to run slower or cause crashes because the game will now render a lot more objects off-screen than it was intended to.
...
G2ME01.gct for Metroid Prime 2: Echoes  
G2ME1R.gct for Randovania Echoes Randomizer games    
...
(Multiplayer will not be supported.)
